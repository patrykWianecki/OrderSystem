...
public class DbConnection {
    ...
    private DbConnection() {
        try {
            ...
            System.err.println("DATABASE DRIVER FAILED DO LOAD " + DRIVER + " [ ERROR " + e.getMessage() + " ]");
        } catch (SQLException e) {
            System.err.println("FAILED TO CONNECT TO DATABASE " + DB_NAME + " [ ERROR " + e.getMessage() + " ]");
        }
    }
    ...
    public void createTables() {
        try {
            ...
            System.err.println("FAILED TO CREATE TABLE [ ERROR " + e.getMessage() + " ]");
        }
    }
    ...
    public void close() {
        if (connection != null) {
            try {
                ...
                System.err.println("FAILED TO CLOSE DATABASE CONNECTION " + DB_NAME);
            }
        }
    }
}
